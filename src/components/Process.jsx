...
const FALLBACK = {
  tag: "How It Works",
  title: "Your Journey to Eating Better",
  titleEm: "Eating Better",
  subtitle: "Four simple steps stand between you and the healthiest meals of your life.",
  steps: [
...
export default function Process() {
  const s = useSection("process", FALLBACK);
  const steps = s.steps?.length ? s.steps : FALLBACK.steps;
    ...
    <section className="section process-section" id="process">
      <div className="container">
        <div className="process-header">
          ...
          >
            <EmTitle title={s.title} em={s.titleEm} />
          </motion.h2>
          <motion.p
